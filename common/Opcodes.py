...
SPECIALREG_RS		=	5
SPECIALREG_SS		=	6
SPECIALREG_COUNTER	=	7
SPECIALREG_COMPARE	=	8
SPECIALREG_INT		=	9
...
SPECIALREGS = {
	...
	'rs': SPECIALREG_RS,
	'ss': SPECIALREG_SS,
	'counter': SPECIALREG_COUNTER,
	'compare': SPECIALREG_COMPARE,
	'int': SPECIALREG_INT
}
...
HVTRAP_SOFTWARE = 3
HVTRAP_PRIVILEGE_VIOL = 4
HVTRAP_SPECIAL_REG_READ = 5
HVTRAP_SPECIAL_REG_WRITE = 6
HVTRAP_HALT = 7
HVTRAP_HARDWARE_ACCESS = 8
HVTRAP_VMRESUME = 9
HVTRAP_TIMER = 10
